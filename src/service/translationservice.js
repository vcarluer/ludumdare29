...
(function () {
	"use strict";
	Game.Service.TranslationService = function (game) {
		this.game = game;
	};

	Game.Service.TranslationService.prototype.getText = function(key) {
		return translations[key][this.game.options.lang].data;
	};
}());